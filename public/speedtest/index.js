/**
 * @source: https://codeberg.org/librespeed/librespeed-frontend/src/branch/master/speedtest.js
 *
 * @licstart  The following is the entire license notice for the
 * JavaScript code in this page.
 *
 * Copyright (C) Federico Dossena
 *
 *
 ...
 */
    ...
    function Speedtest() {
      ...
      Speedtest.prototype = {
         ...
         *   }
         */
        isTestPointsAdded: function() {
          return this._serverList.length != 0;
        },
        ...
        start: function() {
          ...
          this.worker = new Worker("/speedtest/worker.js?r=" + Math.random());
